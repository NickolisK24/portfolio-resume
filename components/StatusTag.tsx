...
const styles: Record<ProjectStatus, string> = {
  ...
  "deployed · active": "text-accent bg-[rgba(127,255,106,0.08)] border-[rgba(127,255,106,0.3)]",
  "active · systems-heavy":
    "text-accent bg-[rgba(127,255,106,0.08)] border-[rgba(127,255,106,0.3)]",
};
...
const labels: Record<ProjectStatus, string> = {
  ...
  "deployed · active": "deployed · active",
  "active · systems-heavy": "active · systems-heavy",
};
